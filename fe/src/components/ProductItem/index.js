...
function ProductItem({ product = {}, showOverView = true }) {
    return (
            ...
            <div className="d-flex flex-column px-5">
                ...
                <div className="product-info my-4">
                    {product.overview && showOverView && (
                        <p className="overview m-0">
                            Vũ Khí Gaming AI Tối Thượng 2024 phiên bản màn hình 16" - PTN16-51. Laptop Gaming AI tiên
                            phong với CPU Intel® Core™ Ultra 7 mới nhất (với nhân NPU chuyên dụng cho các tác vụ AI).
                            Mỏng nhẹ, tinh tế với chất liệu nhôm (20.8mm - 2.05kg), mạnh mẽ với GPU NVIDIA® GeForce™ RTX
                            40 Series, màn hình 16" 2K+ IPS 240Hz siêu tốc, mát nhất phân khúc với 2 quạt (1 quạt
                            AeroBlade™ 3D thế hệ 5), ống đồng dạng Vector và tản nhiệt Kim Loại Lỏng.
                        </p>
                    )}
            ...
            <div className="add-to-cart px-5">
                ...
                <div className="product-add-form mb-5">
                    <div className="product-number d-flex align-items-center mb-4">
                        <span>Số lượng:</span>
                        <Form.Select className="ms-4" size="lg" aria-label="Default select example" defaultValue={1}>
                            <option value="1">1</option>
                            <option value="2">2</option>
                            <option value="3">3</option>
                        </Form.Select>
                    </div>
                    <Button className="add-to-cart-btn w-100 p-2 fs-4 fw-bold rounded-5">Thêm vào giỏ hàng</Button>
                </div>
            </div>
        </div>
    );
